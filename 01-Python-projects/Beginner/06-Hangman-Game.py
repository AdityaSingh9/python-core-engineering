...
#alpha is a constant list containing the lower-case English alphabets
alpha = []
...
while play_again not in ['N', 'n']:
    ...
    #Ending messages
    if wrongs == 6:
        print(f"Game Over! The word is '{word_random}'")
    else:
        print(f"Well donne! The word is '{word_random}'")
